...
function ge() {
  ...
  if (t.lkgCanvas == null)
    ...
    c.appendChild(E), E.style.width = "290px", E.style.whiteSpace = "normal", E.style.color = "rgba(255,255,255,0.7)", E.style.fontSize = "14px", E.style.margin = "5px 0", E.innerHTML = "wxyz2 Click the popup and use WASD, mouse left/right drag, and scroll.";
